...
function infiniteLoop() {
  let condition = true; // Add a condition to control the loop
  while (condition) {
    console.log("Looping...");
    // Add a mechanism to break the loop
    condition = false; // Example: Set condition to false to exit the loop
  }
}
